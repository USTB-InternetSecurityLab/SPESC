...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.smartContractSpecification.IntegerConstant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntegerConstantItemProvider extends ConstantExpressionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SmartContractSpecificationPackage.Literals.INTEGER_CONSTANT__VALUE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IntegerConstant.class)) {
			case SmartContractSpecificationPackage.INTEGER_CONSTANT__VALUE:
