...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.smartContractSpecification.Booleanconstant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanconstantItemProvider extends ConstantExpressionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SmartContractSpecificationPackage.Literals.BOOLEANCONSTANT__VALUE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Booleanconstant.class)) {
			case SmartContractSpecificationPackage.BOOLEANCONSTANT__VALUE:
