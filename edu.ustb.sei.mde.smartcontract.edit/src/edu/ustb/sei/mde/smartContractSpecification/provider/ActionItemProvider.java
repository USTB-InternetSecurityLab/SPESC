...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.smartContractSpecification.Action} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SmartContractSpecificationPackage.Literals.TYPED_ELEMENT__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIsManyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_IsMany_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_IsMany_feature", "_UI_Action_type"),
				 SmartContractSpecificationPackage.Literals.ACTION__IS_MANY,
				 true,
				 false,
				 false,
	...
	protected void addTimesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_Times_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_Times_feature", "_UI_Action_type"),
				 SmartContractSpecificationPackage.Literals.ACTION__TIMES,
				 true,
				 false,
				 false,
	...
	protected void addUsedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_used_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_used_feature", "_UI_Action_type"),
				 SmartContractSpecificationPackage.Literals.ACTION__USED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SmartContractSpecificationPackage.Literals.ACTION__PARAMETERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SmartContractSpecificationPackage.Literals.ACTION__PARAMETERS,
