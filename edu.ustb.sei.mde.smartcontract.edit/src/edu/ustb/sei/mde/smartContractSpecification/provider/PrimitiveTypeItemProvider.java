...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.smartContractSpecification.PrimitiveType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrimitiveTypeItemProvider extends TypeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SmartContractSpecificationPackage.Literals.PRIMITIVE_TYPE__INSTANCE_TYPE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PrimitiveType.class)) {
			case SmartContractSpecificationPackage.PRIMITIVE_TYPE__INSTANCE_TYPE:
