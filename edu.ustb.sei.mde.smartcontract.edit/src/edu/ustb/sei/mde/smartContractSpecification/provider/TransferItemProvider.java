...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.smartContractSpecification.Transfer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransferItemProvider extends TransferOperationItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SmartContractSpecificationPackage.Literals.TRANSFER__ACCOUNT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Transfer"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_Transfer_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Transfer.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SmartContractSpecificationPackage.Literals.TRANSFER__ACCOUNT,
