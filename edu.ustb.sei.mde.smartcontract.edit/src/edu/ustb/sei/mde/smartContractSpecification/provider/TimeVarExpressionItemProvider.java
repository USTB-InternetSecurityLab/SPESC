...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.smartContractSpecification.TimeVarExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimeVarExpressionItemProvider extends TimeExpressionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TimeVarExpressionItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns TimeVarExpression.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TimeVarExpression"));
	}
	...
	public String getText(Object object) {
		TransitiveOperator labelValue = ((TimeVarExpression)object).getTransitive();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_TimeVarExpression_type") :
			getString("_UI_TimeVarExpression_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TimeVarExpression.class)) {
