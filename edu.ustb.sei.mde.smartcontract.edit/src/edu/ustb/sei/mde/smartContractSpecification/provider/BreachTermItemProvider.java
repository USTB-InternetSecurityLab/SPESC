...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.smartContractSpecification.BreachTerm} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BreachTermItemProvider extends TermItemProvider {
	/**
	 ...
	 * @generated
	 */
	public BreachTermItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BreachTerm"));
	}
	...
	public String getText(Object object) {
		String label = ((BreachTerm)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_BreachTerm_type") :
			getString("_UI_BreachTerm_type") + " " + label;
	}
