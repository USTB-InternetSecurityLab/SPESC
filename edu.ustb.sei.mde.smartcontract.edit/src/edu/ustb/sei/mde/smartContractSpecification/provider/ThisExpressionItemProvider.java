...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.smartContractSpecification.ThisExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ThisExpressionItemProvider extends TimeExpressionItemProvider {
	/**
	...
	public String getText(Object object) {
		TransitiveOperator labelValue = ((ThisExpression)object).getTransitive();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ThisExpression_type") :
			getString("_UI_ThisExpression_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ThisExpression.class)) {
