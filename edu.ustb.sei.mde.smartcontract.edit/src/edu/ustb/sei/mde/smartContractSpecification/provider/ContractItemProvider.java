...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.smartContractSpecification.Contract} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContractItemProvider extends NamedElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SmartContractSpecificationPackage.Literals.FIELD_CONTAINER__FIELDS);
			childrenFeatures.add(SmartContractSpecificationPackage.Literals.CONTRACT__PARTIES);
			childrenFeatures.add(SmartContractSpecificationPackage.Literals.CONTRACT__TERMS);
			childrenFeatures.add(SmartContractSpecificationPackage.Literals.CONTRACT__TYPES);
			childrenFeatures.add(SmartContractSpecificationPackage.Literals.CONTRACT__ENUM_TYPES);
			childrenFeatures.add(SmartContractSpecificationPackage.Literals.CONTRACT__ASSETS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SmartContractSpecificationPackage.Literals.FIELD_CONTAINER__FIELDS,
				 SmartContractSpecificationFactory.eINSTANCE.createField()));

		newChildDescriptors.add
			(createChildParameter
				(SmartContractSpecificationPackage.Literals.CONTRACT__PARTIES,
		...
		newChildDescriptors.add
			(createChildParameter
				(SmartContractSpecificationPackage.Literals.CONTRACT__TERMS,
		...
		newChildDescriptors.add
			(createChildParameter
				(SmartContractSpecificationPackage.Literals.CONTRACT__TYPES,
		...
		newChildDescriptors.add
			(createChildParameter
				(SmartContractSpecificationPackage.Literals.CONTRACT__ENUM_TYPES,
				 SmartContractSpecificationFactory.eINSTANCE.createPrimitiveType()));
		...
		newChildDescriptors.add
			(createChildParameter
				(SmartContractSpecificationPackage.Literals.CONTRACT__ASSETS,
				 SmartContractSpecificationFactory.eINSTANCE.createAsset()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == SmartContractSpecificationPackage.Literals.CONTRACT__PARTIES ||
			childFeature == SmartContractSpecificationPackage.Literals.CONTRACT__TYPES ||
			childFeature == SmartContractSpecificationPackage.Literals.CONTRACT__ENUM_TYPES ||
			childFeature == SmartContractSpecificationPackage.Literals.CONTRACT__ASSETS;
