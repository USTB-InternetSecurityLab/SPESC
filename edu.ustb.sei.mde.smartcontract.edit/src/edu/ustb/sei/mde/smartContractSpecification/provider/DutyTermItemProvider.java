...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.smartContractSpecification.DutyTerm} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DutyTermItemProvider extends TermItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DutyTermItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DutyTerm"));
	}
	...
	public String getText(Object object) {
		String label = ((DutyTerm)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DutyTerm_type") :
			getString("_UI_DutyTerm_type") + " " + label;
	}
