...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.smartContractSpecification.RightTerm} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RightTermItemProvider extends TermItemProvider {
	/**
	 ...
	 * @generated
	 */
	public RightTermItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RightTerm"));
	}
	...
	public String getText(Object object) {
		String label = ((RightTerm)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_RightTerm_type") :
			getString("_UI_RightTerm_type") + " " + label;
	}
